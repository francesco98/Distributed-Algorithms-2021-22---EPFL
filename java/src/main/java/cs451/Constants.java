...
public class Constants {
    ...
    public final static int WRITE_LOG_LIMIT = 40000;
    public final static int MAX_BUCKET_LEN = 65000;
    public static final ProtocolType PROTOCOL_TYPE = ProtocolType.FIFO_BROADCAST;

    public static final int ACK_TIMEOUT_MS = 500;

    public static final int OPEN_SOCKET_LIMIT = 1;

    public static final int ACK_THREAD_POOL_SIZE = 2;
    public static final int DELIVERY_THREAD_POOL_SIZE = 4;
